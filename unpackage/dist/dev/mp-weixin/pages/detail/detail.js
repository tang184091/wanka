  ...
  setup(__props) {
    ...
    const formatDateTime = (datetime) => {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/detail/detail.vue:512", "格式化时间错误:", e);
        return "时间格式错误";
      }
    };
    const formatCreateTime = (datetime) => {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/detail/detail.vue:527", "格式化创建时间错误:", e);
        return "";
      }
    };
    const formatRelativeTime = (datetime) => {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/detail/detail.vue:558", "格式化相对时间错误:", e);
        return "";
      }
    };
    const handleAvatarError = (e) => {
      common_vendor.index.__f__("log", "at pages/detail/detail.vue:565", "头像加载失败:", e);
        ...
        success: async (res) => {
          ...
          if (res.confirm) {
            ...
            try {
              ...
              common_vendor.index.__f__("log", "at pages/detail/detail.vue:629", "加入组局结果:", result);
              ...
              common_vendor.index.__f__("error", "at pages/detail/detail.vue:645", "加入组局失败:", err);
              common_vendor.index.showToast({
        ...
        success: async (res) => {
          ...
          if (res.confirm) {
            ...
            try {
              ...
              common_vendor.index.__f__("log", "at pages/detail/detail.vue:694", "退出组局结果:", result);
              if (result.result && result.result.code === 0) {
                await loadGameDetail();
                common_vendor.index.showToast({
                  title: "已退出",
              ...
              common_vendor.index.__f__("error", "at pages/detail/detail.vue:710", "退出组局失败:", err);
              common_vendor.index.showToast({
        ...
        success: async (res) => {
          ...
          if (res.confirm) {
            ...
            try {
              ...
              common_vendor.index.__f__("log", "at pages/detail/detail.vue:793", "取消组局结果:", result);
              if (result.result && result.result.code === 0) {
                await loadGameDetail();
                common_vendor.index.showToast({
                  title: "组局已取消",
              ...
              common_vendor.index.__f__("error", "at pages/detail/detail.vue:814", "取消组局失败:", err);
              common_vendor.index.showToast({
