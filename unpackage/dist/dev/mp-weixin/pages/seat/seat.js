  ...
  setup(__props) {
    ...
    const refreshSeatStatus = async () => {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/seat/seat.vue:222", "获取座位状态失败:", error);
      }
    };
...
该位置空闲，是否立即创建对应类型组局？`,
    ...
    return (_ctx, _cache) => {
      return {
        ...
        p: common_vendor.o(($event) => onSeatTap(arcadeHall.value), "25"),
        ...
        t: common_vendor.o(($event) => onSeatTap(hallDeskRows.value[1][0]), "50"),
        ...
        y: common_vendor.o(($event) => onSeatTap(hallDeskRows.value[1][1]), "05"),
        ...
        C: common_vendor.o(($event) => onSeatTap(hallDeskRows.value[2][0]), "68"),
        ...
        G: common_vendor.o(($event) => onSeatTap(hallDeskRows.value[2][1]), "4d"),
        H: common_vendor.t(interDesk.value.name),
        I: common_vendor.t(getSeatStatusText(interDesk.value.status)),
        J: common_vendor.n(getSeatStatusClass(interDesk.value.status)),
        K: common_vendor.o(($event) => onSeatTap(interDesk.value), "33"),
        ...
        O: common_vendor.o(($event) => onSeatTap(interArcade1.value), "97"),
        ...
        S: common_vendor.o(($event) => onSeatTap(interArcade2.value), "e0"),
        ...
        W: common_vendor.o(($event) => onSeatTap(arcadeRoom.value), "06"),
        ...
        aa: common_vendor.o(($event) => onSeatTap(floor2Left.value[0]), "64"),
        ...
        ae: common_vendor.o(($event) => onSeatTap(floor2Left.value[1]), "e9"),
        ...
        ai: common_vendor.o(($event) => onSeatTap(floor2Left.value[2]), "e4"),
        ...
        am: common_vendor.o(($event) => onSeatTap(floor2Left.value[3]), "54"),
        ...
        aq: common_vendor.o(($event) => onSeatTap(floor2Bottom.value[0]), "c7"),
        ...
        av: common_vendor.o(($event) => onSeatTap(floor2Bottom.value[1]), "98")
      };
    };
  }
};
