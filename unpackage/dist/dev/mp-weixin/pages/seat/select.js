  ...
  setup(__props) {
    ...
    const refreshSeatStatus = async () => {
      ...
      try {
        ...
        common_vendor.index.__f__("error", "at pages/seat/select.vue:192", "获取座位状态失败:", error);
      }
    };
    ...
    return (_ctx, _cache) => {
      return {
        ...
        c: common_vendor.o(onDateChange, "74"),
        d: common_vendor.t(refreshing.value ? "刷新中..." : "刷新"),
        e: refreshing.value ? 1 : "",
        f: common_vendor.o(handleRefresh, "b9"),
        ...
        j: common_vendor.o(($event) => onSeatTap(arcadeRoom.value), "ea"),
        ...
        n: common_vendor.o(($event) => onSeatTap(interArcade1.value), "23"),
        ...
        r: common_vendor.o(($event) => onSeatTap(interArcade2.value), "84"),
        ...
        w: common_vendor.o(($event) => onSeatTap(interDesk.value), "b8"),
        ...
        A: common_vendor.o(($event) => onSeatTap(hallDeskRows.value[2][1]), "bf"),
        ...
        E: common_vendor.o(($event) => onSeatTap(hallDeskRows.value[2][0]), "87"),
        ...
        I: common_vendor.o(($event) => onSeatTap(arcadeHall.value), "7d"),
        ...
        M: common_vendor.o(($event) => onSeatTap(hallDeskRows.value[0][0]), "aa"),
        ...
        Q: common_vendor.o(($event) => onSeatTap(hallDeskRows.value[0][1]), "b6"),
        ...
        U: common_vendor.o(($event) => onSeatTap(hallDeskRows.value[1][0]), "97"),
        ...
        Y: common_vendor.o(($event) => onSeatTap(hallDeskRows.value[1][1]), "0b"),
        ...
        ac: common_vendor.o(($event) => onSeatTap(floor2Bottom.value[1]), "36"),
        ...
        ag: common_vendor.o(($event) => onSeatTap(floor2Bottom.value[0]), "68"),
        ...
        ak: common_vendor.o(($event) => onSeatTap(floor2Left.value[3]), "47"),
        ...
        ao: common_vendor.o(($event) => onSeatTap(floor2Left.value[2]), "14"),
        ...
        as: common_vendor.o(($event) => onSeatTap(floor2Left.value[1]), "4a"),
        ...
        ax: common_vendor.o(($event) => onSeatTap(floor2Left.value[0]), "03")
      };
    };
  }
};
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-bf743fc6"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../.sourcemap/mp-weixin/pages/seat/select.js.map
